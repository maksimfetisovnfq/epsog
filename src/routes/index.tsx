        ...
        <div style={{
            ...
            <div style={{marginTop: '64px', marginBottom: '48px'}}>
                <div style={{fontSize: '48px', marginBottom: '12px'}}>
                    Simuliuokite savo uždarbį
                </div>
                <div style={{fontSize: '20px'}}>
                    Sužinokite lanksčių produktų galimybes
                </div>
            </div>
            ...
            <div style={{fontSize: '16px', marginBottom: '48px'}}>
                ...
                <div>
                    Spustelėkite, kad gautumėte daugiau informacijos apie kiekvieną klausimą
                    ir suprastumėte, kaip jie daro įtaką galimam uždarbiui.
                </div>    
            </div>
            ...
            <div style={{width: '736px', marginLeft: '32px', fontSize: '14px'}}>
                ...
                įvertinti lankstumo technologijų potencialą, remiantis pastarųjų 12 mėn. istoriniais rinkos duomenimis.
                Prieš priimant sprendimus dėl investicijų ar įgyvendinimo, rekomenduojama atlikti 
