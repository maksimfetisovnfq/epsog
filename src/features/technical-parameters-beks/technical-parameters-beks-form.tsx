...
const FormContent = () => {
    ...
    const handleReactionTimeChange = (_event: Event, value: number | number[]) => {
        ...
        setValue('reaction_time', sliderValue, {shouldValidate: true});
    };
    ...
    return (
        <>
            ...
            <div style={{
                ...
                <Slider
                    name="reaction_time"
                    value={typeof reaction_time === 'number' ? reaction_time : 30}
...
export const TechnicalParametersBeksForm = () => {
    ...
    const formDefaultValues = useMemo(() => {
        ...
        const rt = persistedValues.reaction_time;
        let reactionTimeSliderValue = 30; 

        if (typeof rt === 'number') {
            if (reactionTimeReverseMap[rt] !== undefined) {
                reactionTimeSliderValue = reactionTimeReverseMap[rt];
            } else if ([0, 30, 60, 90].includes(rt)) {
                reactionTimeSliderValue = rt;
            }
        }
    ...
    const handleSubmit = (data: TechnicalBeksParametersSchema) => {
        const mappedReactionTime = reactionTimeMap[data.reaction_time as keyof typeof reactionTimeMap] ?? data.reaction_time;
    ...
    return (
        <div style={{fontFamily: 'Arial', width: '760px'}}>
            <GlobalStyles styles={{
                ...
                '.MuiPaper-root.MuiAccordion-root::before': {backgroundColor: 'transparent',},
